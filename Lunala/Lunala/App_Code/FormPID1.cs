...
{
    public partial class FormPID1 : Form
    {
        ...
        private void FormPID1_Load(object sender, EventArgs e)
        {
        ...
        {
            #region //PID1
            if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Kp1)
            {
                numericUpDown_Psi_Kp1.Value = myValue;
            }
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Ki1)
            {
                numericUpDown_Psi_Ki1.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Kd1)
            {
                numericUpDown_Psi_Kd1.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kp1)
            {
                numericUpDown_Loc_Kp1.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Ki1)
            {
                numericUpDown_Loc_Ki1.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kd1)
            {
                numericUpDown_Loc_Kd1.Value = myValue;
            }
            #endregion
            #region //PID2
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Kp2)
            {
                numericUpDown_Psi_Kp2.Value = myValue;
            }
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Ki2)
            {
                numericUpDown_Psi_Ki2.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Psi_Kd2)
            {
                numericUpDown_Psi_Kd2.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kp2)
            {
                numericUpDown_Loc_Kp2.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Ki2)
            {
                numericUpDown_Loc_Ki2.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kd2)
            {
                numericUpDown_Loc_Kd2.Value = myValue;
            }
            #endregion
            #region //PID3
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kp3)
            {
                numericUpDown_Loc_Kp3.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Ki3)
            {
                numericUpDown_Loc_Ki3.Value = myValue;
            }

            else if (myID == Johnbee_SerialPort.MyComId.ID1_Loc_Kd3)
            {
                numericUpDown_Loc_Kd3.Value = myValue;
            }
            #endregion
            #region //示波器
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Osc_CH1) //示波器通道1
            {
            ...
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Osc_CH2)
            {
            ...
            else if (myID == Johnbee_SerialPort.MyComId.ID1_Osc_CH3)
            {
        ...
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kp1.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kp1);
        }

        private void numericUpDown_Loc_Ki1_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Ki1.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Ki1);

        }

        private void numericUpDown_Loc_Kd1_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kd1.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kd1);

        }

        private void numericUpDown_Psi_Kp1_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Kp1.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Kp1);

        }

        private void numericUpDown_Psi_Ki1_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Ki1.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Ki1);
        }

        private void numericUpDown_Psi_Kd1_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Kd1.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Kd1);
        ...
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kp2.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kp2);
        }

        private void numericUpDown_Loc_Ki2_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Ki2.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Ki2);

        }

        private void numericUpDown_Loc_Kd2_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kd2.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kd2);

        }

        private void numericUpDown_Psi_Kp2_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Kp2.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Kp2);

        }

        private void numericUpDown_Psi_Ki2_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Ki2.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Ki2);
        }

        private void numericUpDown_Psi_Kd2_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Psi_Kd2.Value, Johnbee_SerialPort.MyComId.ID1_Psi_Kd2);
        ...
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kp3.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kp3);
        }

        private void numericUpDown_Loc_Ki3_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Ki3.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Ki3);

        }

        private void numericUpDown_Loc_Kd3_ValueChanged(object sender, EventArgs e)
        {
            Johnbee_SerialPort.SetComData(numericUpDown_Loc_Kd3.Value, Johnbee_SerialPort.MyComId.ID1_Loc_Kd3);
